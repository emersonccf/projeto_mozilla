...
class BookListView(ListView):
    ...
    paginate_by = 3  # informa a quantid. e livros por pág na listagem do site
    ...
    def get_queryset(self):
        ...
        # filter(title__icontains='django').order_by('title')[:2]
        return Book.objects.all()

    # se quisermos adicionar algum outro dado na variável de contexto book_list
    # sobreescrevemos o metodo abaixo da seguinte forma: importante seguir o
    # padrão abaixo
